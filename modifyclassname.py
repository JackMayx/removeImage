...
# 项目路径   （找到自己的项目路径）
project_path = '/Users/godox/Resources/majiabao/bao/LLstationeryMster/LLstationeryMster'
# 项目project.pbxproj文件路径 需要更新配置文件中的类名 （找到自己的项目project.pbxproj路径）
pbxpro_path = '/Users/godox/Resources/majiabao/bao/LLstationeryMster/LLstationeryMster.xcodeproj/project.pbxproj'
